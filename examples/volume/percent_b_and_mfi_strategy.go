...
// PercentBandMFIStrategy demonstrates how to compose Bollinger %B and Money
// Flow Index (MFI) into an illustrative multi-indicator strategy.
...
// NewPercentBandMFIStrategyWith initializes an example PercentBandMFIStrategyWith instance with default parameters.
// given parameters.
