// Package volume provides illustrative examples demonstrating how to compose
// volume indicators into trading strategies for educational and research purposes.
//
