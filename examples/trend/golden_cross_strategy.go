...
// GoldenCrossStrategy demonstrates how to compose fast and slow Exponential
// Moving Averages (EMAs) into an illustrative golden cross / death cross crossover strategy.
