...
// DemaStrategy demonstrates how to compose Double Exponential Moving Averages (DEMAs)
...
// NewDemaStrategy initializes an example DemaStrategy instance with default parameters.
