...
// TripleRsiStrategy demonstrates how to compose three Relative Strength Index (RSI)
// calculations of varying periods into an illustrative multi-timeframe strategy.
